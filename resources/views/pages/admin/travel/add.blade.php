...
<div class="container">
    ...
    <br>
    <form action="{{ route('travel.store') }}" method="POST" name="add_content" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="travel_code" class="form-control" placeholder="Enter Content Code">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <strong>Price</strong>
                    <input type="text" min="50000" step="any" class="form-control" name="price" />
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea id="editor" class="form-control" col="4" name="description" placeholder="Enter Description"></textarea>
