...
<div class="container">
  ...
  <br>
  <form action="{{ route('property.update', $data->id) }}" method="POST" name="add_content" enctype="multipart/form-data">
    {{ csrf_field() }}
    @method('PUT')
    <div class="row">
      <div class="col-md-12">
      ...
      <div class="col-md-12">
        <div class="form-group">
          ...
          <input type="text" name="property_code" class="form-control" value="{{$data->property_code}}">
